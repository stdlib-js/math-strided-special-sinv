...
var sinv = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 7', opts, function test( t ) {
	t.strictEqual( sinv.length, 7, 'arity of 7' );
	t.end();
});
...
tape( 'the function supports negative strides', opts, function test( t ) {
	...
	sinv( N, x, -2, x.length-1, y, -1, y.length-2 );
